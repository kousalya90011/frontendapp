...
export default function Slogin({ onSellerLogin }) {
  ...
  //   // Navigate to Forgot Password page or display Forgot Password modal
  ...
  return (
    <div className='card'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <h4 align="center">No Account?
          <button to='register' className='registerButton' onClick={handlesignup}>Register</button>
        </h4>
      </form>
    </div>
  );
